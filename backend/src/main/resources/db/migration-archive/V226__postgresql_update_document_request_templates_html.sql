-- V226: Update document request templates to use professional HTML formatting

-- Delete existing system templates and re-insert with HTML formatting
DELETE FROM pi_document_request_templates WHERE is_system = true;
...
-- Medical Bills Request Template
INSERT INTO pi_document_request_templates (template_code, template_name, document_type, recipient_type, email_subject, email_body, sms_body, is_system, is_active)
VALUES (
'MEDICAL_BILLS_REQUEST',
...
-- Insurance Policy Limits Request Template
INSERT INTO pi_document_request_templates (template_code, template_name, document_type, recipient_type, email_subject, email_body, sms_body, is_system, is_active)
VALUES (
...
-- Wage Documentation Request Template
INSERT INTO pi_document_request_templates (template_code, template_name, document_type, recipient_type, email_subject, email_body, sms_body, is_system, is_active)
VALUES (
'WAGE_DOCUMENTATION_REQUEST',
...
'PHOTOGRAPHS',
'CLIENT',
'Action Required: Documents Needed for Your Case #{{caseNumber}}',
'<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; margin-bottom: 25px;">
                    <tr>
                        <td style="padding: 25px;">
                            ...
                            <p style="color: #333333; font-size: 15px; line-height: 1.8; margin: 0; white-space: pre-line;">{{requestedDocuments}}</p>
                        </td>
                    </tr>
                </table>
...
-- Witness Statement Request Template
INSERT INTO pi_document_request_templates (template_code, template_name, document_type, recipient_type, email_subject, email_body, sms_body, is_system, is_active)
VALUES (
'WITNESS_STATEMENT_REQUEST',
'Witness Statement Request',
'WITNESS',
'WITNESS',
'Witness Statement Request - Incident on {{accidentDate}}',
'<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
COMMENT ON TABLE pi_document_request_templates IS 'Email and SMS templates with professional HTML formatting for document requests';
