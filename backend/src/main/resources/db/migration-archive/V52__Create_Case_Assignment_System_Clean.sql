...
DROP TABLE IF EXISTS case_transfer_requests;
DROP TABLE IF EXISTS workload_calculations;
DROP TABLE IF EXISTS assignment_rules;
DROP TABLE IF EXISTS user_workload;
DROP TABLE IF EXISTS attorney_expertise;
DROP TABLE IF EXISTS case_assignment_history;
DROP TABLE IF EXISTS case_assignments;
DROP VIEW IF EXISTS v_active_case_assignments;
DROP VIEW IF EXISTS v_user_workload_summary;
...
WHERE EXISTS (SELECT 1 FROM legal_cases WHERE id = cra.case_id)
