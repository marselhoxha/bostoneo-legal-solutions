...
public class PIMedicalSummary {
    ...
    // Tier 4: phase-organized chronology with strategic rationale.
    // Array of {phase, phaseRationale, startDate, endDate, recordIds}.
    // Generated by AI alongside the flat treatmentChronology during summary regen.
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "phased_chronology", columnDefinition = "jsonb")
