...
public class LegalCaseDTOMapper {
    ...
    public LegalCaseDTO toDTO(LegalCase entity) {
        ...
        return LegalCaseDTO.builder()
            ...
            .clientInsuranceClaimNumber(entity.getClientInsuranceClaimNumber())
            .clientInsurancePipLimit(entity.getClientInsurancePipLimit())
            .clientInsurancePipDeductible(entity.getClientInsurancePipDeductible())
            .clientInsurancePipDeductiblePaid(entity.getClientInsurancePipDeductiblePaid())
