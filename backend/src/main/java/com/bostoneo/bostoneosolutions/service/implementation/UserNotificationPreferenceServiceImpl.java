...
public class UserNotificationPreferenceServiceImpl implements UserNotificationPreferenceService {
    ...
    private static final List<String> DEFAULT_EVENT_TYPES = Arrays.asList(
        ...
        "DOCUMENT_UPLOADED", "DOCUMENT_VERSION_UPDATED", "CASE_NOTE_ADDED",
        "INVOICE_CREATED", "PAYMENT_RECEIVED", "EXPENSE_SUBMITTED",
        "LEAD_STATUS_CHANGED", "INTAKE_FORM_SUBMITTED", "CALENDAR_EVENT_CREATED",
        "SYSTEM_ISSUE"
    );
