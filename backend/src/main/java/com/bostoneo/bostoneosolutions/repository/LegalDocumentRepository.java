...
public interface LegalDocumentRepository extends JpaRepository<LegalDocument, Long> {
     ...
     */
    @Deprecated
    @Query(value = "SELECT * FROM documents WHERE case_id = :caseId ORDER BY COALESCE(updated_at, uploaded_at) DESC", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM documents WHERE organization_id = :organizationId ORDER BY COALESCE(updated_at, uploaded_at) DESC", nativeQuery = true)
    ...
    @Query(value = "SELECT * FROM documents WHERE case_id = :caseId AND organization_id = :organizationId ORDER BY COALESCE(updated_at, uploaded_at) DESC", nativeQuery = true)
