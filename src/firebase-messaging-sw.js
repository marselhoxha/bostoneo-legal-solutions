...
try {
  ...
  // Firebase config not injected (local dev) or import failed — SW registers but messaging is disabled
  console.warn('Firebase messaging SW initialization skipped:', e.message);
}
