...
export default function Privacy() {
  return <>
    <PageHero badge="Legal" title="Privacy Policy" subtitle="Last updated: March 1, 2026. This policy describes how Legience by Bostoneo Solutions LLC collects, uses, and protects your personal information." />
    <section className="section"><div className="container" style={{ maxWidth: 800, margin: "0 auto" }}>
      <div className="legal-content">
        ...
        <ul>
          <li><strong>Account Information:</strong> Name, email address, phone number, firm name, bar number, and billing information.</li>
        ...
        <ul>
          <li><strong>Encryption:</strong> AES-256 encryption at rest and TLS 1.3 encryption in transit.</li>
          <li><strong>201 CMR 17.00 Compliance:</strong> Full compliance with Massachusetts Standards for the Protection of Personal Information.</li>
          <li><strong>US-Only Data Residency:</strong> All data stored in AWS US-East (Virginia). No offshore processing.</li>
          <li><strong>Role-Based Access:</strong> Configurable permissions ensure users only access data relevant to their role.</li>
          <li><strong>Audit Logs:</strong> Immutable logs of every access, modification, and export action.</li>
        </ul>

        <h2>4. AI and Your Data</h2>
        <p><strong>Zero-Knowledge Architecture:</strong> When you use LegiSearch™, LegiDraft™, or LegiLyze™:</p>
        <ul>
          <li>Your queries and case data are processed in real-time ephemeral memory.</li>
          <li>No attorney-client data is stored after processing is complete.</li>
          <li>Your data is <strong>never</strong> used to train, fine-tune, or improve any AI model.</li>
          <li>Claude AI (by Anthropic) processes queries under a zero-data-retention agreement.</li>
        </ul>

        <h2>5. Data Sharing</h2>
        <p>We do not sell your personal information. We share data only with:</p>
        <ul>
          <li><strong>Service Providers:</strong> Stripe (payments), BoldSign (e-signatures), Twilio (SMS), AWS (hosting), and Anthropic (AI processing) — each bound by data processing agreements.</li>
        ...
        <ul>
          <li>Your data is preserved for 30 days to allow reactivation.</li>
          ...
          <li>We provide cryptographic proof of deletion upon request.</li>
        </ul>
        ...
        <p>If you are a Massachusetts resident, you have additional rights under applicable state laws Chapter 93H and 201 CMR 17.00, including the right to know what personal information we hold about you and the right to request deletion. We maintain a Written Information Security Program (WISP) as required by 201 CMR 17.00.</p>
