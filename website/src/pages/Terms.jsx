...
export default function Terms() {
  return <>
    <PageHero badge="Legal" title="Terms of Service" subtitle="Last updated: March 30, 2026. These terms govern your use of the Legience platform operated by Bostoneo Solutions LLC." />
    <section className="section"><div className="container" style={{ maxWidth: 800, margin: "0 auto" }}>
      <div className="legal-content">
        ...
        <ul>
          ...
          <li><strong>Data Protection:</strong> Your data is not used for AI model training. AI processing is handled through AWS Bedrock under our Business Associate Agreement. See our Privacy Policy for details.</li>
        </ul>
        ...
        <p>The Platform, including its design, code, features, and documentation, is owned by Bostoneo Solutions LLC and protected by intellectual property laws. "Legience," "LegiSpace," "LegiSearch," "LegiDraft," "LegiLyze," "LegiPI," "LegiMed," "LegiValue," and "LegiTrack" are proprietary names of Bostoneo Solutions LLC.</p>

        <h2>9. Limitation of Liability</h2>
        <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, BOSTONEO SOLUTIONS LLC SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, OR USE, ARISING FROM YOUR USE OF THE PLATFORM. Our total aggregate liability shall not exceed the greater of (a) the total fees paid by you in the three (3) months immediately preceding the claim, or (b) one hundred U.S. dollars ($100).</p>
        ...
        <p>Either party may terminate this agreement at any time. Upon termination, your data will be preserved for 90 days to allow for reactivation or data export, after which it will be permanently deleted. You may request data export before termination.</p>
