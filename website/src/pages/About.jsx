...
const values = [
  ...
  { icon: "ri-lock-line", title: "Security Without Compromise", desc: "AES-256 encryption at rest, TLS 1.3 in transit. Zero-knowledge AI architecture — your data is never used to train models. 201 CMR 17.00 compliant. Attorney-client privilege is non-negotiable.", accent: "#0ab39c" },
