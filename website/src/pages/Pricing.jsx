...
const faqs=[
  ...
  {q:"Is my data encrypted and secure?",a:"AES-256 encryption at rest, TLS 1.3 in transit. Full 201 CMR 17.00 compliance (Massachusetts data protection). Zero AI training on your data. All data stored in AWS US-East (Virginia). Immutable audit logs for every action."},
