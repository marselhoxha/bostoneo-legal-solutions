...
const faqs=[
  ...
  {q:"Is my data encrypted and secure?",a:"AES-256 encryption at rest, TLS in transit. Security practices aligned with 201 CMR 17.00 (Massachusetts data protection). AI processed through AWS Bedrock under BAA — zero training on your data. All data stored in AWS US-East. Comprehensive audit logs for every action."},
