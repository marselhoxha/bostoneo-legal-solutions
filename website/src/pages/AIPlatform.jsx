...
export default function AIPlatform(){
  ...
  return<>
    ...
    <PageHero badge="LegiSpace AI" title="AI That Understands" gradient="Your Practice Area." subtitle="Claude-powered LegiSearch™ with cited case law, LegiDraft™ for 30+ document types, and LegiLyze™ for contract and document analysis. Built for every practice area. Secure AI via AWS Bedrock — your data is never used for training."/>
    ...
    <section className="section"><div className="container">
      <div className="feature-showcase reveal">
        <div className="feature-showcase__content">
          ...
          <p className="feature-showcase__desc">One unified workspace for research, drafting, and analysis. Every AI interaction is linked to your cases, accessible from any screen, and exportable to your case files. Powered by Claude AI through AWS Bedrock with BAA coverage.</p>
    ...
    <section className="section reveal"><div className="container">
      <SectionHead badge="Security" title="Secure AI Processing" subtitle="AI features powered through AWS Bedrock under our Business Associate Agreement. Your data is never used for training and stays within US AWS regions."/>
