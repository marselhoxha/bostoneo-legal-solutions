...
const productTabs = [
  { label: "LegiSpace", icon: "ri-brain-line", title: "LegiSpace™ — AI Legal Workspace", desc: "Your all-in-one AI workspace for legal research, document drafting, and case analysis. Ask questions in plain English and get cited answers from federal and state case law. Generate motions, demand letters, briefs, and 30+ document types linked to your cases. Analyze uploaded documents for key facts, risks, and deadlines — all powered by Claude AI with zero-knowledge architecture.", mockup: mockup_ai_workspace, bullets: ["LegiSearch: natural language legal research with verified citations", "LegiDraft: 30+ document types generated from case context", "Document analysis: extract key facts, risks & deadlines from uploads", "Case workflow automation with jurisdiction awareness", "200–500 AI queries/mo included, unlimited on Firm plans", "Zero-knowledge: your data is never used for AI training"] },
...
export default function Home() {
  ...
  const homeFaqSchema={
    ...
    mainEntity:[
      ...
      {"@type":"Question",name:"Is Legience secure enough for law firms?",acceptedAnswer:{"@type":"Answer",text:"Yes. Legience uses AES-256 encryption at rest, TLS 1.3 in transit, is 201 CMR 17.00 compliant, uses zero-knowledge AI architecture (no client data used for training), US-only hosting on AWS, and maintains immutable audit logs."}},
