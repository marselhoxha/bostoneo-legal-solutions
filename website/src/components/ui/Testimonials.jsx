export default function Testimonials(){
  const t=[
    {q:"We replaced Clio and DocuSign — saving $640/month. Built-in AI research turns 3-hour tasks into 20 minutes. Settlement velocity up 31%.",n:"Solo PI Attorney",r:"Boston, MA · 47 cases/year",i:"PI",c:"var(--accent)"},
